...
var _panelImageURL = new URL("@/assets/panel/panelBackground_green.png", import.meta.url).href;
    ...
    methods: {
        ...
        setOptions() {
            if (this.rate > 80) {
                _shadowColor = '#F33333';
                _textColor = '#F33333';
                _panelImageURL = new URL("@/assets/panel/panelBackground_red.png", import.meta.url).href;
            } else {
                _shadowColor = '#20A53A';
                _textColor = '#20A53A';
                _panelImageURL = new URL("@/assets/panel/panelBackground_green.png", import.meta.url).href;
            }
            let option = {
